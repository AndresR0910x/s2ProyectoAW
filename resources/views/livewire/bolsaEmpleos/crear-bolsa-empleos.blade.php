            ...
            <form>
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="mb-4">
                        ...
                        <select class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="nombre_empleo" wire:model="nombre_empleo">
                            <option value="">Seleccionar Empleo</option>
                            @foreach($empleos as $empleo)
                                <option value="{{ $empleo->id_empleo }}">{{ $empleo->nombre_empleo }}</option>
                            @endforeach
                        </select>
                    </div>
